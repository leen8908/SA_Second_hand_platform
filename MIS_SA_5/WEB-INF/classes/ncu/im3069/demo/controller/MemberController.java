...
public class MemberController extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        /** 透過MemberHelper物件的checkDuplicate()檢查該會員帳號是否有重複 */
            ...
            /** 以字串組出JSON格式之資料 */
            String resp = "{\"status\": \'400\', \"message\": \'註冊失敗，此會員帳號已有人使用！\', \'response\': \'\'}";
            /** 透過JsonReader物件回傳到前端（以字串方式） */
            jsr.response(resp, response);
        ...
        /** 透過MemberHelper物件的checkDuplicate()檢查該會員電子郵件信箱是否有重複 */
        	...
        	/** 以字串組出JSON格式之資料 */
            String resp = "{\"status\": \'400\', \"message\": \'註冊失敗，此Email已有人使用！\', \'response\': \'\'}";
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (id.isEmpty()) {
            ...
            resp1.put("message", "所有會員資料取得成功");
            resp1.put("response", query);
    ...
    public void doPut(HttpServletRequest request, HttpServletResponse response)
        ...
        Member m = new Member(id, password, phoneNumber);
